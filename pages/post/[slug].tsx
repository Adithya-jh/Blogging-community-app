  ...
  return (
    <main>
        ...
        {submitted ? (
            <div className="flex flex-col p-10 my-10 bg-yellow-500 text-white max-w-2xl mx-auto">
                <h3 className="text-3xl font-bold ">
                        Thankyou for submitting you comment
                </h3>
                {/* <p> </p> */}
            </div>
        ) : (
        ...
        <form className="flex flex-col p-5 max-w-2xl mx-auto mb-10" onSubmit={handleSubmit(OnSubmit)}>
         ...
         <div className="flex flex-col p-10 my-10 max-w-2xl mx-auto shadow-red-600 shadow space-y-2">
             ...
             {post.comments.map((comment) => (
                 ...
                 <div key={comment._id} className="">
                     <span className="text-yellow-600">{comment.name}</span> <p> : {comment.comment}</p>
                 </div>
             ))}
         </div>
